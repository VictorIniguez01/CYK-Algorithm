...
Gramatica::Gramatica(grammar &G){
    ...
    G.push_back(Rule('A','C','D'));
    G.push_back(Rule('A','C','F'));

    G.push_back(Rule('B','E','B'));
    G.push_back(Rule('B','c',0));

    G.push_back(Rule('C','a',0));

    G.push_back(Rule('D','b',0));

    G.push_back(Rule('E','c',0));

    G.push_back(Rule('F','A','D'));*/
}
